...
const routes = [
  ...
  { path: '/feed',      name: 'feed',        component: () => import('../views/Feed.vue'), meta: { keepAlive: true } },
  { path: '/feed/nuevo', name: 'feed-new',   component: () => import('../views/FeedCreate.vue') },
  { path: '/feed/:id',  name: 'feed-detail', component: () => import('../views/FeedDetail.vue'), props: true },
